...
import { appleGradients } from '../styles/appleTheme';

function AdminLogin() {
  // Apply form interaction fix to prevent button/field interaction issues
  ...
  return (
    <Box
      sx={{
        ...
        padding: 2,
        background: appleGradients.admin?.main || 'linear-gradient(135deg, #e74c3c 0%, #c0392b 100%)',
        position: 'relative',
        overflow: 'hidden',
        '&::before': {
          content: '""',
              ...
              <Button
                ...
                sx={{
                  ...
                  '&:hover': {
                    ...
                    boxShadow: '0 12px 32px rgba(231, 76, 60, 0.6)',
                    '&::before': {
                      left: '100%',
                    }
                  },
