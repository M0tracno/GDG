...
// Define the path to SecuritySettings.js
const filePath = path.join(__dirname, 'src', 'components', 'security', 'SecuritySettings.js');

// New content for the file
const newContent = `// filepath: c:\\Users\\AYUSHMAN NANDA\\OneDrive\\Desktop\\GDC\\src\\components\\security\\SecuritySettings.js
...
console.log('SecuritySettings.js completely rewritten with proper syntax!');
